 ...
 * | Shift|   Z  |   X  |   C  |   V  |  B   ||  N   |   M  |   ,  |   .  |   /  |  ]   |
 * |------+------+------+------+------+------++------+------+------+------+------+------|
 * |Ctl/Bkspc|F12|半全角| Del/|Alt/Spc|GUI/Ent||Space|RShift|   `  |   ¥  |   -  |  =   |
 * `------------------------------------------------------------------------------------'
 */
[_MACBASE] = LAYOUT_planck_grid(
	...
	_______,	_______,	_______,	_______,	_______,	_______,		_______,	_______,	_______,	_______,	_______,	_______,	
	CTL_T(KC_BSPACE),	LT(_MEDIAPlate, KC_F12),	HANZEN_jap0Reng4mac,	LT(_MOUSEPlate, KC_DELETE),	_______,	LGUI_T(KC_ENTER),		_______,	_______,	_______,	_______,	_______,	_______	
