...
//	QK_LGUI,	KC_TAB,	KC_SPC,	QK_LGUI,	KC_LSPO,	TD(_LCTRL_LALT),	LT(MEDIAPlate, KC_ESCAPE),			KC_RSPC,	LT(MOVESPlate, KC_SPC),	KC_MINS,	KC_EQL,	KC_BSLS,	KC_MS_BTN2,	QK_RGUI	
   ...
   * |      |LShift|      |      |      |      |      |   | PgDn |  |   |  [{  |  ]}  |  \|  |RShift|      |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |      | Ins  |ScrLok|LShift| LAlt |      | LCtrl|  |予約済み|     |      |      |      |      |      |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [MOVESPlate] = LAYOUT(
  ...
  [MEDIAPlate] = LAYOUT(
	...
	_______,	_______,	KC_NO,	KC_NO,	KC_NO,	KC_NO,	KC_BSPACE, 		KC_NO,	KC_NO,	KC_COMM,	KC_DOT,	KC_SLSH,	KC_SCLN,	_______,	
	_______,	_______,	_______,	_______,	_______,	_______,	_______,			_______,	HANZENjap_eng,	_______,	_______,	_______,	_______,	_______	
  ),
  ...
  [MOUSEPlate] = LAYOUT(
	...
	XXXXXXX,	_______,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_BSPACE,			KC_AUDIO_VOL_DOWN,	KC_MEDIA_PREV_TRACK,	KC_MEDIA_NEXT_TRACK,	KC_NO,	KC_AUDIO_MUTE,	KC_RSHIFT,	XXXXXXX,
	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	_______,			XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_MS_WH_LEFT,	KC_MS_WH_RIGHT,	XXXXXXX
  )
